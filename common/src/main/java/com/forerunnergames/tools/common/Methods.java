...
public class Methods
{
   ...
   *
   * @param level The desired stack level, where level 0 will return the name of the current method (i.e., the caller
   *              of this method), and each successive increasing level will get the name of the parent calling method.
   *              Must be >= 0, must not specify a level greater than the bottom of the call stack (i.e. the main method).
   *
  ...
  {
    throw new UnsupportedOperationException ("Unsupported method: " + Classes.getClassName (1) + "." + Methods.getMethodName (1));
  }
